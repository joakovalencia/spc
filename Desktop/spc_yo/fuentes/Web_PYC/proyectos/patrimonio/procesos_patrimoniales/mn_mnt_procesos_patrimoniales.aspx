<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="mn_mnt_procesos_patrimoniales.aspx.cs" Inherits="mn_mnt_procesos_patrimoniales" %>
...
<!--
    ...
    function func_valida_eliminar() {
        ...
        if (document.frm_mn_mnt_procesos_patrimoniales.ddlProcesos.value == "(SELECCIONAR)") {
            alert("Debe seleccionar proceso patrimonial.");
            document.frm_mn_mnt_procesos_patrimoniales.ddlProcesos.focus();
            return false;
        }

        if (confirm("¿Seguro que desea eliminar la proceso patrimonial?"))
            return true;
        else
            return false;
    ...
    function func_valida_formulario() {
        ...
        if (confirm("¿Seguro que desea crear-modificar proceso patrimonial?"))
            return true;
        else
            return false;
...
<form id="frm_mn_mnt_procesos_patrimoniales" runat="server">
	...
	<table style="width:100%;">
        ...
        <tr>
            ...
            <td style="width: 60%">
                <table style="WIDTH: 643px">
                    ...
                    <tr>
                        <td class="style1">
                            Proceso Patrimonial</td>
                        <td class="content">
                            <asp:DropDownList ID="ddlProcesos" runat="server" Height="24px" 
                                Width="323px" CssClass="content">
                            </asp:DropDownList>
        ...
        <tr>
            <td style="width: 20%">
                &nbsp;</td>
            <td style="width: 60%" class="title">
                                Listado Procesos Patrimoniales</td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            <td style="width: 20%">
                &nbsp;</td>
            <td style="width: 60%">
                <asp:GridView ID="grdProcesosPatrimoniales" runat="server" CellPadding="4"  
                    AutoGenerateColumns="False" CssClass="content_small" ForeColor="#333333" Width="100%" AutoPostBack="True" 
                                onselectedindexchanged="grdProcesosPatrimoniales_SelectedIndexChanged" >
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:CommandField HeaderText="Seleccionar" ShowSelectButton="True" >
                        <ItemStyle Width="20%" />
                        </asp:CommandField>
                        <asp:BoundField DataField="NOMBRE_PROCESO" HeaderText="Proceso Patrimonial" >
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle Width="20%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="DESC_PROCESO" HeaderText="Desc. Proceso Patrimonial">
                        <ItemStyle Width="60%" />
                        </asp:BoundField>
                        </Columns>
