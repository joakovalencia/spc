<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="mn_mnt_uso_patrimonial_Historico.aspx.cs" Inherits="mn_mnt_uso_patrimonial_Historico" %>
...
<!--
    ...
    {
        if (document.frm_mn_mnt_uso_patrimonial_Historico.ddlCategoria_Uso.value == "(SELECCIONAR)") {
            alert("Debe seleccionar categoria de uso historico.");
            document.frm_mn_mnt_uso_patrimonial_Historico.ddlCategoria_Uso.focus();
            return false;
        }

        if (document.frm_mn_mnt_uso_patrimonial_Historico.ddlCodigo_uso_patrimonial.value == "(SELECCIONAR)") {
            alert("Debe seleccionar código de uso.");
            document.frm_mn_mnt_uso_patrimonial_Historico.ddlCodigo_uso_patrimonial.focus();
            return false;
        }

        if (confirm("¿Seguro que desea eliminar uso historico?"))
            return true;
        else
            return false;
    }
    ...
    function func_valida_formulario() {
        ...
        if (confirm("¿Seguro que desea crear-modificar uso historico?"))
            return true;
        else
            return false;
...
<form id="frm_mn_mnt_uso_patrimonial_Historico" runat="server">
	...
	<table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="content">
                            <asp:DropDownList ID="ddlCategoria_Uso" runat="server" Height="20px" 
                                Width="210" onselectedindexchanged="ddlCategoria_Uso_SelectedIndexChanged" 
        ...
        <tr>
            <td style="width: 20%">
                &nbsp;</td>
            <td style="width: 60%">
                <asp:GridView ID="grdUsoHistorico" runat="server" CellPadding="4" 
                    AutoGenerateColumns="False" CssClass="content_small" ForeColor="#333333" 
                    Width="100%" AutoPostBack="True" 
                                onselectedindexchanged="grdUsoHistorico_SelectedIndexChanged" >
