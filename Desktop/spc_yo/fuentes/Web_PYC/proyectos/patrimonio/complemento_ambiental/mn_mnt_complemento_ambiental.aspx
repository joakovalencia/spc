<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="mn_mnt_complemento_ambiental.aspx.cs" Inherits="mn_mnt_complemento_ambiental" %>
...
<!--
    ...
    function func_valida_eliminar() {
        ...
        if (document.frm_mn_mnt_procesos_patrimoniales.ddlComponente.value == "(SELECCIONAR)") {
            alert("Debe seleccionar complemento ambiental.");
            document.frm_mn_mnt_procesos_patrimoniales.ddlComponente.focus();
            return false;
        }

        if (confirm("¿Seguro que desea eliminar la complemento ambiental?"))
            return true;
        else
            return false;
    ...
    function func_valida_formulario() {
        ...
        if (confirm("¿Seguro que desea crear-modificar complemento ambiental?"))
            return true;
        else
            return false;
	...
	<table style="width:100%;">
                ...
                <table style="WIDTH: 643px">
                    ...
                    <tr>
                        <td class="style1">
                            Complemento</td>
                        <td class="content">
                            <asp:DropDownList ID="ddlComponente" runat="server" Height="24px" 
        ...
        <tr>
            <td style="width: 20%">
                &nbsp;</td>
            <td style="width: 60%" class="title">
                                Listado Complementos Ambientales</td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            <td style="width: 20%">
                &nbsp;</td>
            <td style="width: 60%">
                <asp:GridView ID="grdComplementos" runat="server" CellPadding="4" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="codigo" HeaderText="Codigo Complemento Ambiental" >
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle Width="20%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="descripcion" HeaderText="Desc. Complemento Ambiental">
                        <ItemStyle Width="60%" />
                        </asp:BoundField>
                        </Columns>
