<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="mn_edi_contrato.aspx.cs" Inherits="mn_edi_contrato" %>
	...
	<table style="width:90%;">
        <tr>
            <td style="width: 93px;">
                &nbsp;</td>
            <td class="title">
                Edición Contrato <div class="content_small">(Contrato)</div></td>
        </tr>
        <tr>
            <td>
                &nbsp;</td>
        ...
        <tr>
            ...
            <td style="width: 933px;">
                            <table class="style1">
                                ...
                                <tr>
                                    <td style="width: 15%;" class="content">
                                        Correlativo Convenio</td>
                            ...
                            <asp:TextBox ID="txtCodigoContrato" runat="server" CssClass="content" ReadOnly="True" 
                                ...
                                <tr>
                                    ...
                                    <td style="width: 20%;" class="content">
                                        Sufijo</td>
                                    <td style="width: 40%;" class="content">
                                        <asp:TextBox ID="txtSufijo" runat="server" CssClass="content" 
                                            MaxLength="4" Width="43px" ReadOnly="True"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content">
                                ...
                                <tr>
                                    ...
                                    <td class="content">
                                        <asp:TextBox ID="txtEstatus" runat="server" CssClass="content" MaxLength="100" 
                                            ReadOnly="True" Width="289px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content">
