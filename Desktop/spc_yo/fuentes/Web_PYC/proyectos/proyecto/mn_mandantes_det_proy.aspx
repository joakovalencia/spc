<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mn_mandantes_det_proy.aspx.cs" Inherits="mn_mandantes_det_proy" %>
...
//        }
        ...
        function func_valida_grabar() {
            ...
            if (document.frm_mandantes.ddlMandante.value == "(SELECCIONAR)" || document.frm_mandantes.ddlMandante.value == "")                    
                alert("Debe seleccionar inspector mandante.");
                document.frm_mandantes.ddlMandante.focus();
                return false;
            }
            
            if (confirm("¿Seguro que desea guardar este mandante?"))
                return true;
            else
                return false;
        }
...
//            }
            ...
            if (confirm("¿Seguro que desea eliminar este mandante?"))
                return true;
            else
                return false;
        }
            ...
            <table style="width: 100%; border:thick solid #008BD5;">
                ...
                <asp:GridView ID="grdMandantes" runat="server" CellPadding="4"  
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SIGLA" HeaderText="Mandante" >
