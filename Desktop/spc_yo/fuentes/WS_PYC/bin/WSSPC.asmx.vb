...
'Fecha: 22-04-2014
'Descripción: Se crea Web metodo SetElimina_boleta_garantia_contrato
'</summary>

'<summary>
'Modificado por: Alexi Rodriguez B. - MOP
'Fecha: 10-04-2015
'Descripción:   Se crean Web metodos para agregar funcionalidad de Programación Tentativa propuesta y son los sgtes:
'               - GetBusca_programacion_tentativa_propuesta_financ
'               - GetBusca_programacion_tentativa_propuesta_financ_suma
...
Imports PYC.Utilities

' <System.Web.Script.Services.ScriptService()> _
<System.Web.Services.WebService(Namespace:="http://www.pyc.cl/")> _
...
#Region "Metodos JG"
  ...
  Public Function SetMnt_Ing_Proyectos(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_SetMnt_Ing_Proyectos(parametro, _
                                                                       region, _
                                                                       tipo_proy, _
                                                                       plan, _
                                                                       producto, _
                ...
                Dt = ac.SetMnt_Ing_Proyectos(region, _
                                             tipo_proy, _
                                             plan, _
                                             producto, _
                                             proceso, _
  ...
  Public Function GetLlena_Codigo_Contratos(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_GetLlena_Codigo_Contratos(parametro, _
                                                                            str_region_inicio, _
                                                                            str_region_fin, _
                                                                            str_fecha_inicio, _
                                                                            str_fecha_fin) Then
                ...
                Dt = ac.GetLlena_Codigo_Contratos(str_region_inicio, _
                                                  str_region_fin, _
                                                  str_fecha_inicio, _
                                                  str_fecha_fin)
...
Public Function GetBusca_Proyectos(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_GetBusca_Proyectos(parametro, _
                                                                     str_tipo_proyecto, _
                                                                     str_region_inicio, _
                                                                     str_region_fin, _
                                                                     str_estado_inicio, _
                                                                     str_estado_fin, _
                                                                     str_proceso_inicio, _
                                                                     str_proceso_fin, _
                                                                     str_bd_con_proy, _
                                                                     str_con_proy) Then
                Dim ac As New AccessLayer()

                Dt = ac.GetBusca_Proyectos(str_tipo_proyecto, _
                                           str_region_inicio, _
                                           str_region_fin, _
                                           str_estado_inicio, _
                                           str_estado_fin, _
...
Public Function GetBusca_Proyecto_Encabezado(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_GetBusca_Proyecto_Encabezado(parametro, _
                                                                               codigo_pia, _
                                                                               codigo_region) Then
                Dim ac As New AccessLayer()
...
Public Function GetBusca_Proyecto_Contratos_Relacionados_Encabezado(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_GetBusca_Proyecto_Contratos_Relacionados_Encabezado(parametro, _
                                                                                                      codigo_pia, _
                                                                                                      codigo_region) Then
                Dim ac As New AccessLayer()
...
Public Function GetBusca_Proyecto_Contratos_Relacionados_Detalle(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_GetBusca_Proyecto_Contratos_Relacionados_Detalle(parametro, _
                                                                                                   codigo_pia, _
                                                                                                   codigo_region) Then
                Dim ac As New AccessLayer()
...
Public Function GetContratistaAdjudicado(ByVal parametro As String) As XmlDocument
  ...
  Public Function SetGraba_Contratos_Detalle_Datos(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_SetGraba_Contratos_Detalle_Datos(parametro, _
                                                                                   codigo_pia, _
                                                                                   codigo_region, _
                                                                                   sufijo, _
                                                                                   strlegal, _
                                                                                   ...
                                                                                   strejecucion, _
                                                                                   straumento_costos, _
                                                                                   strexplicacion_o_alertas, _
                                                                                   strapertura_licitacion, _
                                                                                   strprimera_piedra, _
                                                                                   strinauguracion) Then
                Dim ac As New AccessLayer()

                Retorno = ac.SetGraba_Contratos_Detalle_Datos(codigo_pia, _
                                                              codigo_region, _
                                                              sufijo, _
                                                              strlegal, _
                                                              strambiental, _
  ...
  Public Function SetGraba_Contratos_Detalle_Edicion(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_SetGraba_Contratos_Detalle_Edicion(parametro, _
                                                                                     codigo_pia, _
                                                                                     codigo_region, _
                                                                                     sufijo, _
                ...
                Retorno = ac.SetGraba_Contratos_Detalle_Edicion(codigo_pia, _
                                                                codigo_region, _
                                                                sufijo, _
                                                                numcorrelativo_convenio, _
                                                                strmandante_convenio, _
  ...
  Public Function SetMnt_Comunas(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_SetMnt_Comunas(parametro, _
                                                                 accion, _
                                                                 region, _
                                                                 provincia, _
                                                                 comuna, _
   ...
   Public Function Get_busca_localizacion(ByVal parametro As String) As XmlDocument
    ...
    Public Function Set_Graba_Contratos_Detalle_Datos(ByVal parametro As String) As XmlDocument
        ...
        Try
            ...
            If ValidateInput.GetInstance().Valida_Set_Graba_Contratos_Detalle_Datos(parametro, codigo_pia, codigo_region, _
                                                                                   ...
                                                                                   intProximo_Hito, strResp_Administrativo) Then
                Dim ac As New AccessLayer()
                ...
                Dt = ac.Set_Graba_Contratos_Detalle_Datos(codigo_pia, codigo_region, _
                                                          ...
                                                          strEJECUCION, strAUMENTO_COSTOS, _
                                                          strEXPLICACION_O_ALERTAS, strAPERTURA_LICITACION, _
                                                          strPRIMERA_PIEDRA, strINAUGURACION, intProximo_Hito, strResp_Administrativo)
    ...
    <WebMethod()> _
       Public Function SetGraba_consultoria_detalle_termino(ByVal parametro As String) As XmlDocument
        ...
        Dim calificacion_con As String = ""
        Dim observacion_termino_contrato As String = ""
...
#Region "Conexion ORACLE"
    ...
    Public Function SetGraba_Datos_Exploratorio(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_SetGraba_Datos_Exploratorio(parametro, _
                                                                            strCodigoProyecto, _
                                                                            strCodigoProceso, _
                                                                            strNombreProyecto, _
                                                                            strObjeto, _
                                                                            strCodigoRegion, _
                                                                            strCodigoProvincia, _
                                                                            strCodigoComuna, _
                                                                            strCodigoBip, _
                                                                            strAnoInicio, _
                                                                            strMontoEstimado, _
                                                                            strEtapaMideplan, _
                                                                            strMontoEstimadoxEtapa _
                                                                   ) Then
                Dim ac As New AccessLayer()

                Dt = ac.SetGraba_Datos_Exploratorio(strCodigoProyecto, _
                                                    strCodigoProceso, _
                                                    strNombreProyecto, _
                                                    strObjeto, _
                                                    strCodigoRegion, _
...
#Region "EKV"
    ...
    Public Function SetMnt_valida_existencia_contrato(ByVal parametro As String) As XmlDocument
        ...
        Try
            ...
            If ValidateInput.GetInstance().Valida_SetMnt_valida_existencia_contrato(parametro, _
                ...
                Dt = ac.SetMnt_valida_existencia_contrato(cod_con, _
                                            codigo_da)
    ...
    Public Function SetMnt_updateImagenesContratos(ByVal parametro As String) As XmlDocument
        ...
        Try
            ...
            If ValidateInput.GetInstance().Valida_SetMnt_updateImagenesContratos(parametro, _
                ...
                Dt = ac.SetMnt_updateImagenesContratos(cod_con, _
                                            codigo_da, _
                                            pathImagen, _
                                            nombImagen, _
                                            TipoImagen)
    ...
    Public Function SetMnt_ImagenesContrato_BorraContrato(ByVal parametro As String) As XmlDocument
        ...
        Try
            'Valido el XML enviado como parametro
            If ValidateInput.GetInstance().Valida_SetMnt_ImagenesContrato_BorraContrato(parametro, _
                                                                cod_con) Then
